...
public interface FactoryResolver {
    /**
     * Resolves a factory from the given class. This method may set the value of the provided {@link Mutable}. The
     * exact rules for doing so are implementation-dependent and therefore unspecified.
     *
