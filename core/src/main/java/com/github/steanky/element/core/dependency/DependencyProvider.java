...
public interface DependencyProvider {
    ...
    /**
     * An object which can be used to access a dependency. Consists of a type (class) and a key used to disambiguate in
     * the case of multiple dependencies of the same type.
     *
