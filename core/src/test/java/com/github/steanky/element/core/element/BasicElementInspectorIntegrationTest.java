...
public class BasicElementInspectorIntegrationTest {
    ...
    public static class SimpleElementClass {
        private static final ElementFactory<Data, SimpleElementClass> FACTORY = (objectData, data, dependencyProvider) ->
    ...
    public static class DataAnnotationInConstructor {
        private static final ElementFactory<Data, DataAnnotationInConstructor> FACTORY = (objectData, data, dependencyProvider) ->
                new DataAnnotationInConstructor(objectData);
    ...
    public static class MissingFactoryAnnotation {
        private static final ElementFactory<Data, MissingFactoryAnnotation> FACTORY = (objectData, data, dependencyProvider) ->
                new MissingFactoryAnnotation(objectData);
    ...
    public static class MissingProcessorAnnotation {
        private static final ElementFactory<Data, MissingProcessorAnnotation> FACTORY = (objectData, data, dependencyProvider) ->
                new MissingProcessorAnnotation(objectData);
    ...
    public static class MissingProcessorAndFactoryAnnotation {
        private static final ElementFactory<Data, MissingProcessorAndFactoryAnnotation> FACTORY = (objectData, data, dependencyProvider) ->
                new MissingProcessorAndFactoryAnnotation(objectData);
    ...
    public static class NullFactory {
        private static final ElementFactory<Data, NullFactory> FACTORY = (objectData, data, dependencyProvider) ->
    ...
    public static class NullProcessor {
        private static final ElementFactory<Data, NullProcessor> FACTORY = (objectData, data, dependencyProvider) ->
                new NullProcessor(objectData);
    ...
    public static class BadFactoryReturnType {
        private static final ElementFactory<Data, Object> FACTORY = (objectData, data, dependencyProvider) ->
                new BadFactoryReturnType(objectData);
    ...
    public static class SubclassFactoryReturnType {
        private static final ElementFactory<Data, Subclass> FACTORY = (objectData, data, dependencyProvider) ->
    ...
    public static class DataAndDependenciesFactory {
        ...
        public static ElementFactory<Data, DataAndDependenciesFactory> FACTORY = (objectData, data, dependencyProvider) ->
                new DataAndDependenciesFactory(objectData, dependencyProvider
                        .provide(Key.key("test:dependency"), null));
        private final Data data;
