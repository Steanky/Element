...
A DI-like framework for creating standardized "component" objects from configuration files. It's meant for Minecraft
developers, but it doesn't depend on any particular platform.
